DROP TABLE T_GRW_MEASUREMENT_PROCESS_STEP;
DROP TABLE T_GRW_IMPROVEMENT_MEASUREMENT;
DROP TABLE T_GRW_MEASUREMENT;
DROP TABLE T_GRW_SUSTAINABLE_IMPROVEMENT_ACTIONS;
DROP TABLE T_GRW_PROCESS_STEP;
DROP TABLE T_GRW_PROCESS_BADGE;
DROP TABLE T_GRW_BADGE;
DROP TABLE T_GRW_SUSTAINABLE_GOAL;
DROP TABLE T_GRW_PRODUCT;
DROP TABLE T_GRW_PROCESS_RESOURCE;
DROP TABLE T_GRW_RESOURCE;
DROP TABLE T_GRW_PROCESS;
DROP TABLE T_GRW_COMPANY_REPRESENTATIVE;
DROP TABLE T_GRW_USER;
DROP TABLE T_GRW_COMPANY;
DROP TABLE T_GRW_ADDRESS;
DROP TABLE T_GRW_STEP;
DROP TABLE T_GRW_MEASUREMENT_TYPE;
DROP TABLE T_GRW_BADGE_LEVEL;
DROP TABLE T_GRW_PRODUCT_TYPE;
DROP TABLE T_GRW_RESOURCE_TYPE;
DROP TABLE T_GRW_SECTOR;
DROP TABLE T_GRW_USER_TYPE;
...
CREATE TABLE T_GRW_USER_TYPE(
	...
	dt_updated_at DATE NULL,
	dt_finished_at DATE NULL
);
